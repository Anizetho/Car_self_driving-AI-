...
# Définition des lebels et features
label_1 = direction
label_2 = acceleration
features_test_1 = Result_data.drop('direction', axis=1)
features_test_1 = features_test_1.drop('acceleration', axis=1)
features_test_2 = Result_data.drop('acceleration', axis=1)

# Créations des modèles
regr_1 = linear_model.LinearRegression()
regr_1.fit(features_test_1,label_1)

regr_2 = linear_model.LinearRegression()
regr_2.fit(features_test_2,label_2)
